...
public class CalcEstoqueTecidoPlano {
	...
	public static Float calcular() throws SQLException {
		...
		String query = "SELECT " + 
						...
						"WHERE BAS.CODIGO_DEPOSITO = '741' " +
						"	AND BS3.UNIDADE_MEDIDA = 'MT' " + 
						"   AND EST.QTDE_ESTOQUE_ATU > 0 " + 
						"   AND BS3.CONTA_ESTOQUE = 22 " + 
	...
	public static String calcularToString() throws SQLException {
		return NumberUtils.floatToStringDecimal(CalcEstoqueTecidoPlano.calcular());
	}
